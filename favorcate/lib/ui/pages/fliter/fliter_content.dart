...
class SLFliterContent extends StatelessWidget{
  @override
  ...
  Widget buildChoiceTitle(BuildContext context){
    return Container(
      ...
      child: Text("展示您的选择",style: Theme.of(context).textTheme.display3.copyWith(fontWeight: FontWeight.bold),),
    );
  }

  Widget buildChoiceSelect(){
    return Expanded(
      child: Consumer<SLFliterViewModel>(
