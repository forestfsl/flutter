...
class SLHomeContent extends StatelessWidget{
  @override
  Widget build(BuildContext context) {
    // TODO: implement build
    return FutureBuilder<List<SLCategoryModel>>(
      future: SLJsonParse.getCategoryData(),
      builder: (ctx, snapshot) {
        ...
        return GridView.builder(
            ...
            itemBuilder: (ctx, index) {
              return SLHomeCategoryItem(categories[index]);
            }
        );
      },
    );
