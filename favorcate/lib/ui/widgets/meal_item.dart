...
class SLMealItem extends StatelessWidget {
  final SLMealModel _meal;
  SLMealItem(this._meal);
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      onTap: () {
        Navigator.of(context).pushNamed(SLDetailScreen.routeName, arguments: _meal);
      },
    );
  }
  ...
  Widget buildOperationInfo() {
    return Padding(
      ...
      child: Row(
        ...
        children: <Widget>[
          SLOperationItem(Icon(Icons.schedule), "${_meal.duration}分钟"),
          SLOperationItem(Icon(Icons.restaurant), "${_meal.complexStr}"),
          buildFavorItem()
        ],
      ),
    );
