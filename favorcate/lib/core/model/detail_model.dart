...
//
//     final SLDetailModel = SLDetailModelFromJson(jsonString);

import 'dart:convert';

SLDetailModel slDetailModelFromJson(String str) => SLDetailModel.fromJson(json.decode(str));

String slDetailModelToJson(SLDetailModel data) => json.encode(data.toJson());
...
class SLDetailModel {
  ...
  factory SLDetailModel.fromJson(Map<String, dynamic> json) => SLDetailModel(
    iid: json["iid"],
