...
import 'package:helloflutter/douban/widgets/dashied_line.dart';
import 'package:helloflutter/douban/widgets/start_rating.dart';

class SLHomeMovieItem extends StatelessWidget{
  final MoveItem movie;
  SLHomeMovieItem(this.movie);
    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Text("想看",
          style: TextStyle(fontSize: 18,color: Color.fromARGB(255, 235, 170, 60)))
        ],
      ),
    );
  }
